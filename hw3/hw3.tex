    ...
    \begin{solution}
      \begin{enumerate}
        ...
        \item A Transformation-Based Approach
          ...
          To answer the static counting problem, a slightly different approach is needed to be able to easily find the number of colors intersected. The transformed points are stored in a balanced search tree based on their $x$-coordinates (i.e. the
