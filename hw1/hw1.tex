...
\begin{enumerate}
  ...
  \item
    ...
    \begin{solution}
      ...
      point $\overline{p_{i-1} p'}$ is tangent to $H_j$. Any other point $q \in S_j$ couldn't be a possible next point because the segment
      ...
      condition, but one will clearly put the set $S_j$ ``outside'' of the convex hull.) Using a binary search, finding this possible point $p' \in
